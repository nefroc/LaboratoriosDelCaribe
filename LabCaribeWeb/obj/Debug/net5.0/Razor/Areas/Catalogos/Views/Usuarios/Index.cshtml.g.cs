#pragma checksum "/Users/neftalirodriguez/Projects/LaboratoriosDelCaribe/LabCaribeWeb/Areas/Catalogos/Views/Usuarios/Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "64c52544eb9b4cf4a9c6a394ecd49cacf4ac6f92"
// <auto-generated/>
...
namespace AspNetCore
{
    ...
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"64c52544eb9b4cf4a9c6a394ecd49cacf4ac6f92", @"/Areas/Catalogos/Views/Usuarios/Index.cshtml")]
        ...
        var app = new Vue({
            ...
            methods: {
                obtenerListaUsuarios: function () {
                    axios.get('");
#nullable restore
#line 208 "/Users/neftalirodriguez/Projects/LaboratoriosDelCaribe/LabCaribeWeb/Areas/Catalogos/Views/Usuarios/Index.cshtml"
                ...
                btnEliminarUsuario_click: function (item) {
                    this.$confirm('El usuario ' + item.nombre + ' ' + item.apellidos + ' se eliminará permanentemente. ¿Desea continuar?', 'Confirmar', {
                        ...
                        try {
                            axios.delete('");
#nullable restore
#line 222 "/Users/neftalirodriguez/Projects/LaboratoriosDelCaribe/LabCaribeWeb/Areas/Catalogos/Views/Usuarios/Index.cshtml"
                    ...
                    this.$refs['nuevoUsuario'].validate((valid) => {
                        if (valid) {
                            try {
                                axios.post('");
#nullable restore
#line 251 "/Users/neftalirodriguez/Projects/LaboratoriosDelCaribe/LabCaribeWeb/Areas/Catalogos/Views/Usuarios/Index.cshtml"
...
#nullable restore
#line 274 "/Users/neftalirodriguez/Projects/LaboratoriosDelCaribe/LabCaribeWeb/Areas/Catalogos/Views/Usuarios/Index.cshtml"
                          Write(Url.Action("GetUsuario", "Usuarios"));

#line default
#line hidden
#nullable disable
                WriteLiteral(@"?idUsuario=' + id, this.nuevoUsuario).then(response => {
                            console.log(response.data)
                    ...
                    this.$refs['actualizarUsuario'].validate((valid) => {
                        if (valid) {
                            try {
                                ...
                                axios.put('");
#nullable restore
#line 288 "/Users/neftalirodriguez/Projects/LaboratoriosDelCaribe/LabCaribeWeb/Areas/Catalogos/Views/Usuarios/Index.cshtml"
